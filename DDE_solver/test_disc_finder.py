import numpy as np
from rkh import find_discontinuity_chain  # Import your function
...
discs_ex1 = find_discontinuity_chain(alpha_const_delay, t0_ex1, tend_ex1, h_guess_ex1)
...
discs_ex2 = find_discontinuity_chain(alpha_linear_delay, t0_ex2, tend_ex2, h_guess_ex2)
...
discs_ex3 = find_discontinuity_chain(
    alpha_nonlinear_delay, t0_ex3, tend_ex3, h_guess_ex3
)
